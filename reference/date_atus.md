...
A wrapper on
[`gsdd::date_atus()`](https://poissonconsulting.github.io/gsdd/reference/date_atus.html)
to calculats the date on which a specified number of Accumulated Thermal
Units (ATUs) are exceeded.
